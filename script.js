...
// إنشاء محتوى المقايسة للطباعة أو التصدير
function generateEstimateContent() {
...
document.getElementById('printSelected').addEventListener('click', () => {
    const printContainer = generateEstimateContent();
...
document.getElementById('downloadPDF').addEventListener('click', () => {
    ...
    html2pdf()
        .set({
            ...
            html2canvas: {
                scale: 3, // زيادة الدقة لدعم النصوص العربية
                useCORS: true, // دعم تحميل الصور
...
document.getElementById('downloadImage').addEventListener('click', () => {
    ...
    html2canvas(printContainer, {
        ...
        link.download = 'مقايسة_بطاح_الأصلي.png';
